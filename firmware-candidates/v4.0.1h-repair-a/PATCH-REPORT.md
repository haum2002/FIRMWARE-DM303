...
Profile: `v401h-repair-a` - repair profile after V4.0.1h field failure: keep only the exp14/exp16 recovery core and V4.0.1h marker while removing Malay slot/resource and UI-theme changes for measurement isolation.
...
- Version strings are marked `V4.0.1h` as a visible exp20 safe-Malay-SP flash marker.
...
- Output SHA-256: `66315b32c079842251143450bb853c5f60a29bb27c93b73f03389a9813b1cd36`
...
| `0x02ca0` | 16 | `4d 54 31 30 30 4d 4d 20 56 34 2e 30 20 00 00 00` | `4d 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 68 00` | preserve model ID and mark candidate version as V4.0.1 beta |
| `0x02cb0` | 16 | `42 54 31 30 30 4d 4d 20 56 34 2e 30 20 00 00 00` | `42 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 68 00` | preserve model ID and mark candidate version as V4.0.1 beta |
