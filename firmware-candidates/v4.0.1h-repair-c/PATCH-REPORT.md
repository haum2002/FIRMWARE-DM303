...
Profile: `v401h-repair-c` - measurement repair profile: repair-b latency/state recovery plus moderate vendor-path relay/mux settle timing for cleaner zeroing after physical switching.
...
- Relay/range selector waits in function `0x0801f0f2` are extended to `5/8/50` ticks.
...
- Version strings are marked `V4.0.1i` as a visible repair-c measurement flash marker.
...
- Output SHA-256: `70b98735978f711c2203c0b907927aded22eb91ca03fdc601ebdfb33f56b117d`
...
| `0x02ca0` | 16 | `4d 54 31 30 30 4d 4d 20 56 34 2e 30 20 00 00 00` | `4d 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 69 00` | preserve model ID and mark candidate version as V4.0.1 beta |
| `0x02cb0` | 16 | `42 54 31 30 30 4d 4d 20 56 34 2e 30 20 00 00 00` | `42 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 69 00` | preserve model ID and mark candidate version as V4.0.1 beta |
