...
Profile: `v401h-repair-e` - clean UI measurement candidate: keep official runtime fail-stop guards, official UI resources, repair-b current latency caps, and immediate mode/range calls.
...
- Version strings are marked `V4.0.1k` as a visible repair-e clean-UI measurement flash marker.
...
- Output SHA-256: `75dffe2bbe1ed3193c3073f39d018c888f4a684440e17647645bd18d7ef40216`
...
| `0x02ca0` | 16 | `4d 54 31 30 30 4d 4d 20 56 34 2e 30 20 00 00 00` | `4d 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 6b 00` | preserve model ID and mark candidate version as V4.0.1 beta |
| `0x02cb0` | 16 | `42 54 31 30 30 4d 4d 20 56 34 2e 30 20 00 00 00` | `42 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 6b 00` | preserve model ID and mark candidate version as V4.0.1 beta |
