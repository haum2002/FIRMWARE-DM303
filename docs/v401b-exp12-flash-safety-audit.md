...
- Current SHA-256: `0a2090bf5c42cd89509f65881d8b54862d243c6b9d224478ab95bb3ef8e06a16`
- Differing bytes: `195`
- Differing ranges: `81`
...
| Current hash matches exp12 final | `PASS` | `0a2090bf5c42cd89509f65881d8b54862d243c6b9d224478ab95bb3ef8e06a16` |
...
| Every changed byte is allowlisted | `PASS` | `195` changed bytes classified |
| Vector changes are only self-loop recovery redirects | `PASS` | `55` vector entries changed |
| Critical exp12 patch bytes present | `PASS` | `12` byte guards checked |
