# DM303 V3.16 / V4.0 / V4.0.1f comparison
...
| v4.0.1f | `dm303_firmware/DM303-V4.0.1-beta/DM303V4.0.1-beta.bin` | 203260 | `a9cc0fc643fa79378b04ab4c00fd7303551c63e2d75329b623f529f8856e90fe` | `0x0801754d` | `0x0754c` |
...
### v4.0.1f
- `0x02ca0`: `MT100MM V4.0.1f`
- `0x02cb0`: `BT100MM V4.0.1f`
- `0x04260`: `Loading DM30XDB1 ...`
- `0x04278`: `\system\DM30XDB1.dat`
...
| v4.0.1f | `0x0801f0f2` | `0x0801f0ac` | `0x0801f19a` | v4-original | 2 | 3 | 10 |
