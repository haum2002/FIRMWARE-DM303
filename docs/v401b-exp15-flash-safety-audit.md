# DM303 V4.0.1b exp15 flash safety audit
...
- Current SHA-256: `3a2db571a4c783d0df2a454ec13d8d38a3a22a0e6ad7cc9993a0afa1edd7f3a0`
- Size unchanged: `PASS`
- Reset vector unchanged: `PASS`
- All changed bytes inside allowed exp15 intervals: `PASS`
- Critical exp15 byte guards present: `PASS`
...
|---:|---|---|---|---|
| `0x02ca0` | visible main version marker | `4d 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 63 00` | `4d 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 63 00` | `PASS` |
| `0x02cb0` | visible secondary version marker | `42 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 63 00` | `42 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 63 00` | `PASS` |
...
| `0x09818` | exp15 stale bit0 gate A | `01 e0` | `01 e0` | `PASS` |
| `0x098b4` | exp15 stale bit0 gate B | `01 e0` | `01 e0` | `PASS` |
| `0x09950` | exp15 stale bit0 gate C | `03 e0` | `03 e0` | `PASS` |
| `0x0f19a` | mode/range entry branch to wrapper | `1e f0 34 ba` | `1e f0 34 ba` | `PASS` |
| `0x15812` | exp15 immediate switch gate A | `00 bf` | `00 bf` | `PASS` |
| `0x15838` | exp15 immediate switch gate B | `00 bf` | `00 bf` | `PASS` |
| `0x1585e` | exp14 current-switch latency cap A | `b0 f5 c8 6f` | `b0 f5 c8 6f` | `PASS` |
| `0x15862` | exp15 immediate switch gate C | `00 bf` | `00 bf` | `PASS` |
| `0x15888` | exp14 current-switch latency cap B | `b0 f5 c8 6f` | `b0 f5 c8 6f` | `PASS` |
| `0x1588c` | exp15 immediate switch gate D | `00 bf` | `00 bf` | `PASS` |
| `0x2c4ea` | debug/semihosting fail-stop returns | `70 47` | `70 47` | `PASS` |
| `0x2d5c0` | boot-logo delay wrapper prefix | `10 b5` | `10 b5` | `PASS` |
...
| `0x045b2` | `1` | boot-logo load call routed through delay wrapper | `PASS` |
| `0x045b4` | `2` | boot-logo load call routed through delay wrapper | `PASS` |
...
| `0x09818` | `2` | exp15 first stale bit0 early-error gate bypass | `PASS` |
| `0x098b4` | `2` | exp15 second stale bit0 early-error gate bypass | `PASS` |
| `0x09950` | `2` | exp15 parsed stale bit0 early-error gate bypass | `PASS` |
...
| `0x15812` | `2` | exp15 first immediate mode/range gate | `PASS` |
| `0x15838` | `2` | exp15 second immediate mode/range gate | `PASS` |
| `0x15860` | `4` | exp14 first current-switch latency cap, exp15 first return-to-mode gate | `PASS` |
| `0x1588a` | `4` | exp14 second current-switch latency cap, exp15 second return-to-mode gate | `PASS` |
| `0x25bf8` | `3` | language menu name renamed to Melayu | `PASS` |
| `0x25bfc` | `3` | language menu name renamed to Melayu | `PASS` |
| `0x2c4ea` | `2` | debug/semihosting fail-stop returns | `PASS` |
| `0x2d5c0` | `14` | boot-logo delay wrapper code cave | `PASS` |
