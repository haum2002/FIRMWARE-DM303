...
Profile: `stream-recovery-exp16-ui-safe` - exp14 recovery bytes with visible V4.0.1d marker, exp15 aggressive gates removed, and boot-logo delay disabled for UI/loading isolation.
...
- Version strings are marked `V4.0.1d` as a visible exp16 UI-safe flash marker.
...
- Output SHA-256: `29a8bd71cba65538ba25d8e76aa5122234f9a28ad957287ba82fbf4fdf6c60af`
...
| `0x02ca0` | 16 | `4d 54 31 30 30 4d 4d 20 56 34 2e 30 20 00 00 00` | `4d 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 64 00` | preserve model ID and mark candidate version as V4.0.1 beta |
| `0x02cb0` | 16 | `42 54 31 30 30 4d 4d 20 56 34 2e 30 20 00 00 00` | `42 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 64 00` | preserve model ID and mark candidate version as V4.0.1 beta |
