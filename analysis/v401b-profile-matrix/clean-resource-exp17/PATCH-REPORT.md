...
Profile: `clean-resource-exp17` - clean resource-restore build: official measurement/control flow, visible V4.0.1e marker, fault/fail-stop recovery only, and external DM30XDB1 resource restored by the final merge.
...
- Version strings are marked `V4.0.1e` as a visible exp17 clean resource-restore flash marker.
...
- Output SHA-256: `d3760c42731a5fd6c0db508b51df85b1725046f028d767315916c4ee58904b77`
...
| `0x02ca0` | 16 | `4d 54 31 30 30 4d 4d 20 56 34 2e 30 20 00 00 00` | `4d 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 65 00` | preserve model ID and mark candidate version as V4.0.1 beta |
| `0x02cb0` | 16 | `42 54 31 30 30 4d 4d 20 56 34 2e 30 20 00 00 00` | `42 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 65 00` | preserve model ID and mark candidate version as V4.0.1 beta |
