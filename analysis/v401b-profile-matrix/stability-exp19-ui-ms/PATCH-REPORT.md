...
Profile: `stability-exp19-ui-ms` - exp19 UI-restored stability build: keep exp18 bounded recovery and DM30XDB1 resource fix while re-enabling the Melayu/SP slot and safe dark resource pack.
...
- Version strings are marked `V4.0.1g` as a visible exp19 UI-restored stability flash marker.
...
- Output SHA-256: `24c3bd15282b3e43e42c0e45a7743261469283e61d345bf46a8483eb9350342d`
...
| `0x02ca0` | 16 | `4d 54 31 30 30 4d 4d 20 56 34 2e 30 20 00 00 00` | `4d 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 67 00` | preserve model ID and mark candidate version as V4.0.1 beta |
| `0x02cb0` | 16 | `42 54 31 30 30 4d 4d 20 56 34 2e 30 20 00 00 00` | `42 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 67 00` | preserve model ID and mark candidate version as V4.0.1 beta |
