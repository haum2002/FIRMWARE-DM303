...
Profile: `stability-exp18-resource` - exp18 resource-complete stability build: restore exp14/exp16 bounded recovery and AC-to-DC latency caps on top of the proven DM30XDB1-complete package, with UI/language slots kept official.
...
- Version strings are marked `V4.0.1f` as a visible exp18 resource-complete stability flash marker.
...
- Output SHA-256: `a9cc0fc643fa79378b04ab4c00fd7303551c63e2d75329b623f529f8856e90fe`
...
| `0x02ca0` | 16 | `4d 54 31 30 30 4d 4d 20 56 34 2e 30 20 00 00 00` | `4d 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 66 00` | preserve model ID and mark candidate version as V4.0.1 beta |
| `0x02cb0` | 16 | `42 54 31 30 30 4d 4d 20 56 34 2e 30 20 00 00 00` | `42 54 31 30 30 4d 4d 20 56 34 2e 30 2e 31 66 00` | preserve model ID and mark candidate version as V4.0.1 beta |
